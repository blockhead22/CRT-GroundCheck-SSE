...
const AVAILABLE_MODELS: ModelOption[] = [
  {
    ...
    name: 'CRT Reasoning',
    provider: 'Built-in',
    description: 'Full pipeline: memory, gates, contradiction detection',
    isLocal: true,
    isReasoning: true,
  },
  {
    ...
    description: 'Default fast + code route — active model',
    isLocal: true,
  },
  {
    ...
    name: 'DeepSeek R1',
    provider: 'Ollama (Local)',
    description: 'Reasoning route for complex queries',
    isLocal: true,
    isReasoning: true,
  },
  {
    ...
    name: 'Llama 3.2',
    provider: 'Ollama (Local)',
    description: 'Lightweight fallback (not default)',
    isLocal: true,
  },
]
