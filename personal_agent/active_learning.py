...
class ActiveLearningCoordinator:
    ...
    def record_interaction(
        ...
        If interaction_id is supplied (pre-generated by the route handler so it
        can be returned to the client before the background thread runs), it is
        used as-is.  Otherwise a new UUID is generated.
