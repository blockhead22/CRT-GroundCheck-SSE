#!/usr/bin/env python
"""
Train the DNNT model.

Usage:
    python -m personal_agent.dnnt.train_model --synthetic 1000 --epochs 20
...
def main():
    parser = argparse.ArgumentParser(description='Train the DNNT model')
    ...
    print("\nTo use in your API:")
    print("  from personal_agent.dnnt import ReasoningInference")
