...
class CRTEnhancedRAG:
    ...
    # ── Inline sanitizers (ported from crt_rag_old.py) ──
    ...
    def _sanitize_unsupported_memory_claims(
        ...
        *,
        ...
        memory_claim = any(
            p in t
            for p in (
                "i remember", "i recall", "i have a memory", "i have it noted",
                "i have you down", "i have stored", "in my memory", "in my notes",
                "i've got it stored", "i've got you stored", "i've got it noted",
                "i've got you down",
            )
        )
        if not memory_claim:
