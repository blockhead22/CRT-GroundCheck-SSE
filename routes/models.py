...
class ChatSendRequest(BaseModel):
    ...
    generation_mode: Optional[str] = Field(default=None, description="Request-scoped provider mode override")
    cloud_model_openai: Optional[str] = Field(default=None, description="Optional request-scoped OpenAI model override")
    cloud_model_claude: Optional[str] = Field(default=None, description="Optional request-scoped Claude model override")
