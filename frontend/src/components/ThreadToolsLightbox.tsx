                    ...
                    <div className="mt-3 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="rounded border border-white/10 bg-white/5 px-3 py-2 text-xs text-white/80 hover:bg-white/10"
                        >
                          Cancel
                        </button>
                        <button
                          onClick={() => void props.onReset(confirmTarget)}
                          className="rounded bg-rose-600 px-3 py-2 text-xs font-semibold text-white hover:bg-rose-500"
                        >
                          Yes, reset
                        </button>
                      </div>
