  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ scale: 1 }}
        exit={{ scale: 0.95 }}
        className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded bg-white shadow-lg"
        ...
        <div className="sticky top-0 z-10 border-b border-gray-200 bg-white px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                onClick={expandAll}
                className="rounded px-3 py-1 text-sm text-gray-600 hover:bg-gray-100 transition-colors"
              >
                Expand All
              </button>
              <button
              ...
              <button
                onClick={onClose}
                className="rounded px-3 py-1.5 text-gray-600 hover:bg-gray-100 transition-colors"
              >
...
function StepCard({ step, isExpanded, onToggle, getActionIcon, formatTimestamp }: StepCardProps) {
  ...
  return (
    <div className="rounded border border-gray-200 bg-white overflow-hidden hover:border-gray-300 transition-colors">
      {/* Step Header */}
      <button
        onClick={onToggle}
