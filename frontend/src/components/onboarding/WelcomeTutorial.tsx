        ...
        >
          ...
          <AnimatePresence mode="wait">
            {step === 'intro' && (
              ...
              >
                ...
                <div className="flex gap-3">
                  <button
                    onClick={handleSkip}
                    className="flex-1 rounded border border-white/10 bg-white/5 px-6 py-3 font-medium text-white/70 transition hover:bg-white/10"
                  >
                    Skip Tutorial
                  </button>
                  <button
                    onClick={handleNext}
                    className="flex-1 rounded bg-gradient-to-r from-violet-600 to-purple-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:shadow-xl hover:brightness-110"
                  >
                    Start Tutorial →
                  </button>
                </div>
            ...
            {step === 'create-fact' && (
              ...
              >
                <div>
                  <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded bg-blue-500/20 text-3xl">
                    1️⃣
                  </div>
                ...
                <div className="rounded-sm border border-blue-500/30 bg-blue-500/10 p-6">
                  ...
                  <button
                    ...
                    className="w-full rounded bg-blue-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-blue-700"
                  >
                    Send Message
                  </button>
                </div>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={handleSkip}
                    className="rounded border border-white/10 bg-white/5 px-6 py-3 text-sm font-medium text-white/70 transition hover:bg-white/10"
                  >
                    Skip
                  </button>
                </div>
            ...
            {step === 'update-fact' && (
              ...
              >
                <div>
                  <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded bg-orange-500/20 text-3xl">
                    2️⃣
                  </div>
                ...
                <div className="rounded-sm border border-orange-500/30 bg-orange-500/10 p-6">
                  ...
                  <button
                    ...
                    className="w-full rounded bg-orange-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-orange-700"
                  >
                    Send Message
                  </button>
                </div>
            ...
            {step === 'see-disclosure' && (
              ...
              >
                <div>
                  <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded bg-green-500/20 text-3xl">
                    3️⃣
                  </div>
                ...
                <div className="rounded-sm border border-green-500/30 bg-green-500/10 p-6">
                  ...
                  <button
                    ...
                    className="w-full rounded bg-green-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-green-700"
                  >
                    Ask Question
                  </button>
                </div>
            ...
            {step === 'explore-ledger' && (
              ...
              >
                <div>
                  <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded bg-purple-500/20 text-3xl">
                    4️⃣
                  </div>
                ...
                <div className="flex gap-3">
                  {props.onNavigateToDashboard && (
                    <button
                      ...
                      className="flex-1 rounded border border-purple-500/30 bg-purple-500/10 px-6 py-3 font-medium text-purple-300 transition hover:bg-purple-500/20"
                    >
                      View Full Ledger
                    </button>
                  )}
            ...
            {step === 'complete' && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full max-w-xs rounded bg-gradient-to-r from-violet-600 to-purple-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition hover:shadow-xl hover:brightness-110"
                >
                  Start Chatting
                </button>
              </motion.div>
