...
| `labs/meaning_compression_lab/scaffold_model_sweep.py` | cross-model scaffold-vs-raw sweep | minutes | Ollama mode; model list is configurable |
| `labs/meaning_compression_lab/scaffold_ablation.py` | layer-by-layer meaning scaffold ablation | seconds-minutes | deterministic is offline; Ollama mode needs local model |
